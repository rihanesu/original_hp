...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 row">
            ...
            <div class="access-body col-md-6">
                <ul class="access-list">
                    <li>教室　林本麦子ピアノ教室</li>
                    <li>住所　愛知県江南市草井町西３９</li>
                    <li>最寄駅　名鉄犬山線　江南駅　名鉄各務原線　二十軒駅</li>
                    <li>場所　すいとぴあ江南から、徒歩１分弱<br>
                    ...
                    <li>小学校からの距離<br>
                        ...
                        各務原市立　川島小学校より車で１１分</li>
                    <li>電話番号　０５８７ー５３ー３５２３</li>
                </ul>
            </div>
        </div>
    </div>
